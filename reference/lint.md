...
#> ::warning file=/tmp/RtmpRuY7hO/file194b11079df9.R,line=1,col=1::file=/tmp/RtmpRuY7hO/file194b11079df9.R,line=1,col=1,[any(duplicated(rnorm(5)))] anyDuplicated(x, ...) > 0 is better than any(duplicated(x), ...).

lint_text("any(duplicated(rnorm(5)))
any(is.na(x))
")
#> ::warning file=/tmp/RtmpRuY7hO/file194b797bd7f6.R,line=1,col=1::file=/tmp/RtmpRuY7hO/file194b797bd7f6.R,line=1,col=1,[any(duplicated(rnorm(5)))] anyDuplicated(x, ...) > 0 is better than any(duplicated(x), ...).
#> ::warning file=/tmp/RtmpRuY7hO/file194b797bd7f6.R,line=2,col=1::file=/tmp/RtmpRuY7hO/file194b797bd7f6.R,line=2,col=1,[any(is.na(x))] anyNA(x) is better than any(is.na(x)).
...
#> ::warning file=/tmp/RtmpRuY7hO/file194b60b0f0cd,line=2,col=1::file=/tmp/RtmpRuY7hO/file194b60b0f0cd,line=2,col=1,[x = c(1, 2, 3)] Use <-, not =, for assignment.
#> ::warning file=/tmp/RtmpRuY7hO/file194b60b0f0cd,line=3,col=1::file=/tmp/RtmpRuY7hO/file194b60b0f0cd,line=3,col=1,[any(duplicated(x), na.rm = TRUE)] anyDuplicated(x, ...) > 0 is better than any(duplicated(x), ...).
#> ::warning file=/tmp/RtmpRuY7hO/file194b60b0f0cd,line=5,col=1::file=/tmp/RtmpRuY7hO/file194b60b0f0cd,line=5,col=1,[any(duplicated(x))] anyDuplicated(x, ...) > 0 is better than any(duplicated(x), ...).
#> ::warning file=/tmp/RtmpRuY7hO/file194b60b0f0cd,line=7,col=5::file=/tmp/RtmpRuY7hO/file194b60b0f0cd,line=7,col=5,[any(is.na(x))] anyNA(x) is better than any(is.na(x)).
#> ::warning file=/tmp/RtmpRuY7hO/file194b60b0f0cd,line=11,col=1::file=/tmp/RtmpRuY7hO/file194b60b0f0cd,line=11,col=1,[any(
#>   duplicated(x)
