...
#> ::warning file=/tmp/RtmpPXGfWf/file32324653c437.R,line=1,col=1::file=/tmp/RtmpPXGfWf/file32324653c437.R,line=1,col=1,[any(duplicated(rnorm(5)))] anyDuplicated(x, ...) > 0 is better than any(duplicated(x), ...).

lint_text("any(duplicated(rnorm(5)))
any(is.na(x))
")
#> ::warning file=/tmp/RtmpPXGfWf/file323257b02f5d.R,line=1,col=1::file=/tmp/RtmpPXGfWf/file323257b02f5d.R,line=1,col=1,[any(duplicated(rnorm(5)))] anyDuplicated(x, ...) > 0 is better than any(duplicated(x), ...).
#> ::warning file=/tmp/RtmpPXGfWf/file323257b02f5d.R,line=2,col=1::file=/tmp/RtmpPXGfWf/file323257b02f5d.R,line=2,col=1,[any(is.na(x))] anyNA(x) is better than any(is.na(x)).
...
#> ::warning file=/tmp/RtmpPXGfWf/file3232522de0f2,line=2,col=1::file=/tmp/RtmpPXGfWf/file3232522de0f2,line=2,col=1,[x = c(1, 2, 3)] Use <-, not =, for assignment.
#> ::warning file=/tmp/RtmpPXGfWf/file3232522de0f2,line=3,col=1::file=/tmp/RtmpPXGfWf/file3232522de0f2,line=3,col=1,[any(duplicated(x), na.rm = TRUE)] anyDuplicated(x, ...) > 0 is better than any(duplicated(x), ...).
#> ::warning file=/tmp/RtmpPXGfWf/file3232522de0f2,line=5,col=1::file=/tmp/RtmpPXGfWf/file3232522de0f2,line=5,col=1,[any(duplicated(x))] anyDuplicated(x, ...) > 0 is better than any(duplicated(x), ...).
#> ::warning file=/tmp/RtmpPXGfWf/file3232522de0f2,line=7,col=5::file=/tmp/RtmpPXGfWf/file3232522de0f2,line=7,col=5,[any(is.na(x))] anyNA(x) is better than any(is.na(x)).
#> ::warning file=/tmp/RtmpPXGfWf/file3232522de0f2,line=11,col=1::file=/tmp/RtmpPXGfWf/file3232522de0f2,line=11,col=1,[any(
#>   duplicated(x)
